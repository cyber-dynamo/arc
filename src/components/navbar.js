    ...
    <div className="bg-gray-900">
      <nav className="flex items-center justify-between px-4 py-3">
        ...
        <div className={`md:flex ${showMenu ? 'block' : 'hidden'}`}>
          ...
          <a href="esupply" target="_blank" rel="noopener noreferrer" className="block mt-4 md:inline-block md:mt-0 text-white hover:text-gray-300 mr-4">
          E-supply</a>
          <a href="adapt" target="_blank" rel="noopener noreferrer" className="block mt-4 md:inline-block md:mt-0 text-white hover:text-gray-300 mr-4">
          Adapt</a>
