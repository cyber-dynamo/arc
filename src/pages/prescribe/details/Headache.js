      ...
      <div>
        ...
        <table className="border-collapse border border-green-800 m-4">
          <tbody>
            ...
            <tr className='formtitle'>
              <td colSpan={7}>
              <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800" onClick={() => handleCopy(98890037)}>
                              <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                              Headache
                              </span>                               
                              </button>
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient is experiencing a tightening, throbbing or pulsating ache in the head with a pain level of 2 out of 10 since a day ago. There are no signs of nausea or vomiting, light sensitivity or ocular symptoms. It happens without aura and less than 15 times a month. The symptoms align with that of headache. This has happened before in the past prior to this episode and occasionally. So far, the patient has not attempted any medications but had tried over the counter painkillers such as tylenol in the previous episode with moderate success. It is reported that stress, lack of sleep, strong smell can worsen the symptoms and resting or sleeping can alleviate them. Patient is over 5yo but under 50 yo without recent injuries to the head. The condition also does not impair speech, sensation ,strength and consciousness. The patient presents without fever and neck stiffness and there were no recent head trauma. Hence, urgent referral is not required. Patient is currently on NO RELATED MEDICATIONS. Kidney or liver issues are also unremarkable. Patient is not pregnant and reports to have NO ALLERGIES to any medications."}
                />
              </td>
            </tr>
            <tr className='formtitle'>
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient should feel the alleviation and disappearance of pain within 2 to 24 hours. Monitor for adverse effects of the medication, including, stomach upset, nausea and cramps. It should be taken with food to prevent stomach complications. A headache diary/log should be kept and ths use of medication should be limited to 14 days/month."}
                />
              </td>
            </tr>
            <tr>
