            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient is experiencing thickened, brittle and yellowish brown toe nail(s) since about a few weeks ago. The symptoms align with that of fungal nail infections Onychomycosis. This has happened before in the past prior to this episode and the patient was diagnosed. The patient has not attempted over the counter medications. It is reported that nothing worsens or alleviates the symptoms. Patient is over 18yo without uncontrolled diabetes and is not immunocompromised. There were no history of nail traumas, < 50% of the nail(s) are affected and less than 3 nails are affected. There are no signs of systemic illness such as fever or swollen lymph glands. Hence, urgent referral is not required. Patient is currently on NO RELATED MEDICATIONS. Kidney or liver issues are also unremarkable. Patient is not pregnant and reports to have NO ALLERGIES to any medications."}
                />
              </td>
            </tr>
            <tr className='formtitle'>
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient was advised to monitor the effectiveness for 12-18 months. Discolored, brittle nails should be absent. Monitor for adverse effects of the medication, including, local irritations, redness, stinging and mild itching, which should subside in a few days. If symptoms worsen, new lesions have appeared,systemic infections are present, see a doctor."}
                />
              </td>
            </tr>
            <tr>
