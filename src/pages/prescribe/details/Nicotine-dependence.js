      ...
      <div>
        ...
        <table className="border-collapse border border-green-800 m-4">
          <tbody>
            ...
            <tr className='formtitle'>
              <td colSpan={7}>
              <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800" onClick={() => {
    const code = "98890069";
    handleCopy(code);
    window.open(`smokecess`, '_blank');
  }}>
                              <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                              Nicotine Dependence
                              </span>                               
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient wishes to quit smoking but experienced cravings, dysphoria, depressed mood, irritation, frustration, insomnia and anger upon smoking cessation. The symptoms align with that of nicotine dependence. This has never happened before in the past as the patient has never attempted to quit smoking. The patient has not tried any over the counter medications. It is reported that heat worsens the symptoms but smoking alleviates them. Patient is over 18 yo and does not have unstable cardiovascular diseases, depression and anxiety. Patient also has no history of anorexia nervosa or bulimia nervosa. Hence, urgent referral is not required. Patient is currently on NO RELATED MEDICATIONS. Kidney or liver issues are also unremarkable. Patient is not pregnant and reports to have NO ALLERGIES to any medications."}
                />
              </td>
            </tr>
            <tr className='formtitle'>
