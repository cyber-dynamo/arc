      ...
      <div>
        ...
        <table className="border-collapse border border-green-800 m-4">
          <tbody>
            ...
            <tr className='formtitle'>
              <td colSpan={7}>
              <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800" onClick={() => handleCopy(98890029)}>
                              <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                              Fungal Infections
                              </span>                               
                              </button>
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient is experiencing small, round, red patches with well defined borders since about a week ago. The patches burn and itch. The symptoms align with that of fungal infections. This has never happened before in the past prior to this episode. The patient has not attempted over the counter medications. It is reported that scratching worsens the symptoms but nothing alleviates them. Patient is over 2yo without uncontrolled diabetes and is not immunocompromised. Lesions are not extensive, severely inflamed, painful and disabling. There are no signs of systemic illness such as fever or swollen lymph glands. Hence, urgent referral is not required. Patient is currently on NO RELATED MEDICATIONS. Kidney or liver issues are also unremarkable. Patient is not pregnant and reports to have NO ALLERGIES to any medications."}
                />
              </td>
            </tr>
            <tr className='formtitle'>
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  className='forminput border border-gray-400 p-2 rounded-md'
                  style={{ resize: 'none', width: '100%', minHeight: '200px', height: 'auto' }}
                  defaultValue={"Patient is counseled to use a hair dryer to dry up the area as much as possible, avoid scrubbing the lesions, wear cotton clothes and not to share personal items. Lamisil 1% CR qd prn**** is prescribed to help alleviate the symptoms. Medical intervention is necessary to alleviate the symptoms as other non-pharmacological interventions have failed. The effectiveness of the prescription is supported by evidence as per RxTx, medsask and BC guidelines. The prescription is safe for the patient as the dosage is within the therapeutic range as per RxTx and the patient is not allergic to it. Adherence should not be an issue as the patient is young and aware. There are also family members in case a reminder is needed."}
                />
              </td>
            </tr>
            <tr className='formtitle'>
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient was advised to monitor the effectiveness for up to 7 days. Lesions should be alleviated and burning and itching sensations should be absent. Monitor for adverse effects of the medication, including, local irritations, redness, stinging and mild itching, which should subside in a few days. If symptoms worsen, new lesions have appeared,systemic infections are present, see a doctor."}
                />
              </td>
            </tr>
            <tr>
