      ...
      <div>
        ...
        <table className="border-collapse border border-green-800 m-4">
          <tbody>
            ...
            <tr className='formtitle'>
              <td colSpan={7}>
              <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800" onClick={() => handleCopy(98890061)}>
                              <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient should feel the alleviation of pain and swelling within 30 to 60 minutes. Any symptoms should resolve in 2 weeks. Monitor for adverse effects of the medication, including stomach upset and nausea. It should be taken with food and plenty of water to prevent stomach complications."}
                />
              </td>
            </tr>
            <tr>
