      ...
      <div>
        ...
        <table className="border-collapse border border-green-800 m-4">
          <tbody>
            ...
            <tr className='formtitle'>
              <td colSpan={7}>
              <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800" onClick={() => handleCopy(98890049)}>
                              <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                              Impetigo
                              </span>                               
                              </button>
            ...
            <tr>
              <td colSpan="7">
                <textarea
                  ...
                  defaultValue={"Patient was told that significant healing should occur within 48 hours and lesions should heal within 5 to 10 days. Monitor for adverse effects of the medication, including, local irritations, redness, stinging and mild itching, which should subside in a few days. If spreading or worsening, see family doctor."}
                />
              </td>
            </tr>
            <tr>
