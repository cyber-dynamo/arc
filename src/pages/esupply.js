      ...
      <div className="w-full sm:w-auto flex-grow">
        ...
        <table className="table-auto w-full">
          <tbody>
            ...
            <tr>
              <td className="border px-4 py-1">Emergency Supply Details: <textarea className="border border-gray-400 px-4 py-2 w-full" style={{ resize: 'none', height: '20px' }}></textarea></td>
              <td className="border px-4 py-1">Fax: {chill ? "604-279-8961" : "604-270-2228"}</td>
            </tr>
            <tr>
              <td className="border px-4 py-1">Date of Emergency Supply: <CurrentDate /></td>
              <td className="border px-4 py-1">Signature: {/* Icon component here */}</td>
            </tr>
            <tr>
              <td className="border px-4 py-1" colSpan={2}>Rationale for Emergency Supply (Including Instructions for Patient and Follow-Up Plan)</td>
            </tr>
            <tr>
            ...
            <tr>
              <td className="border px-4 py-1" colSpan={2}>The patient and/or their representative was provided sufficient information, including risks and benefits associated with the Emergency Supply and voluntarily provided their consent.</td>
            </tr>
            <tr>
